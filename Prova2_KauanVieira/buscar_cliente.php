                    ...
                    <?php foreach ($clientes as $cliente): ?>
                        <tr>
                            ...
                            <td class="action-links">
                                <a href="alterar_cliente.php?id=<?= htmlspecialchars($cliente['id_cliente']) ?>" class="edit-link">
                                    <i class="fas fa-edit"></i> Alterar
                                </a>
                                <a href="excluir_cliente.php?id=<?= htmlspecialchars($cliente['id_cliente']) ?>" class="delete-link" onclick="return confirm('Tem certeza que deseja excluir este cliente?')">
